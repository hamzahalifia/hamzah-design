        ...
        >
          <div className="relative z-10 flex flex-col items-center text-center max-w-lg">
            ...
            <motion.p
              ...
              className="text-base leading-6 text-[#52525B] dark:text-[#A1A1AA] mb-8 max-w-sm"
            >
            ...
            >
              ...
              <button
                ...
                className="inline-flex items-center justify-center px-6 py-3 btn-radius-lg text-base font-semibold border border-attio-border-light dark:border-[#27272A] text-[#52525B] dark:text-[#D4D4D8] hover:bg-neutral-50 dark:hover:bg-neutral-900/60 transition-all active:scale-95 cursor-pointer"
              >
