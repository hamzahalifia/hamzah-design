...
const CustomVideoPlayer = ({ src }) => {
  ...
  // Sync fullscreen state (e.g. if user presses Esc)
  useEffect(() => {
  ...
  const triggerShowControls = () => {
    ...
    }, 2500); // Hide controls after 2.5s of no activity if playing
  };
  ...
  return (
    ...
    >
      ...
      <div
        ...
        onClick={(e) => e.stopPropagation()} // Prevent triggering container clicks/taps
      >
        {/* Play/Pause Button */}
        <button
          type="button"
