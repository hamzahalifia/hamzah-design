...
export default function HomePage() {
  ...
  return (
    ...
    >
      ...
      />
      {/* <Navbar /> */}
      <main aria-label="Home page content" className="relative z-10 bg-[#F2F0EB] dark:bg-[#080809] border-b border-attio-border-light dark:border-attio-border-dark transition-colors duration-300">
        <div className="max-w-[1440px] mx-auto px-0 lg:px-6">
          <div className="flex flex-col lg:flex-row gap-0 border-l-0 border-r-0 lg:border-l lg:border-r border-attio-border-light dark:border-attio-border-dark bg-[#FAF8F5] dark:bg-[#0A0A0B]">
            <ProfileSidebar />
