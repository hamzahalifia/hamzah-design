...
export const filledColors: Record<BadgeColors, { root: string; addon: string; addonButton: string }> = {
    gray: {
        root: "bg-neutral-100 text-neutral-700 ring-neutral-200/80 dark:bg-white/10 dark:text-neutral-200 dark:ring-white/10",
        addon: "text-neutral-500 dark:text-neutral-400",
        addonButton: "hover:bg-neutral-200 text-neutral-400 hover:text-neutral-500 dark:hover:bg-white/20 dark:text-neutral-400 dark:hover:text-neutral-200",
    },
    brand: {
        root: "bg-blue-50 text-blue-700 ring-blue-200/80 dark:bg-blue-950/40 dark:text-blue-300 dark:ring-blue-800/60",
        addon: "text-blue-500 dark:text-blue-400",
        addonButton: "hover:bg-blue-100 text-blue-400 hover:text-blue-500 dark:hover:bg-blue-900/50 dark:text-blue-400 dark:hover:text-blue-200",
    },
    error: {
        root: "bg-red-50 text-red-700 ring-red-200/80 dark:bg-red-950/40 dark:text-red-300 dark:ring-red-800/60",
        addon: "text-red-500 dark:text-red-400",
        addonButton: "hover:bg-red-100 text-red-400 hover:text-red-500 dark:hover:bg-red-900/50 dark:text-red-400 dark:hover:text-red-200",
    },
    warning: {
        root: "bg-amber-50 text-amber-700 ring-amber-200/80 dark:bg-amber-950/40 dark:text-amber-300 dark:ring-amber-800/60",
        addon: "text-amber-500 dark:text-amber-400",
        addonButton: "hover:bg-amber-100 text-amber-400 hover:text-amber-500 dark:hover:bg-amber-900/50 dark:text-amber-400 dark:hover:text-amber-200",
    },
    success: {
        root: "bg-emerald-50 text-emerald-700 ring-emerald-200/80 dark:bg-emerald-950/40 dark:text-emerald-300 dark:ring-emerald-800/60",
        addon: "text-emerald-500 dark:text-emerald-400",
        addonButton: "hover:bg-emerald-100 text-emerald-400 hover:text-emerald-500 dark:hover:bg-emerald-900/50 dark:text-emerald-400 dark:hover:text-emerald-200",
    },
    slate: {
        root: "bg-slate-100 text-slate-700 ring-slate-200/80 dark:bg-slate-800/60 dark:text-slate-200 dark:ring-slate-700/60",
        addon: "text-slate-500 dark:text-slate-400",
        addonButton: "hover:bg-slate-200 text-slate-400 hover:text-slate-500 dark:hover:bg-slate-700 dark:text-slate-400 dark:hover:text-slate-200",
    },
    sky: {
        root: "bg-sky-50 text-sky-700 ring-sky-200/80 dark:bg-sky-950/40 dark:text-sky-300 dark:ring-sky-800/60",
        addon: "text-sky-500 dark:text-sky-400",
        addonButton: "hover:bg-sky-100 text-sky-400 hover:text-sky-500 dark:hover:bg-sky-900/50 dark:text-sky-400 dark:hover:text-sky-200",
    },
    blue: {
        root: "bg-blue-50 text-blue-700 ring-blue-200/80 dark:bg-blue-950/40 dark:text-blue-300 dark:ring-blue-800/60",
        addon: "text-blue-500 dark:text-blue-400",
    ...
    indigo: {
        root: "bg-indigo-50 text-indigo-700 ring-indigo-200/80 dark:bg-indigo-950/40 dark:text-indigo-300 dark:ring-indigo-800/60",
        addon: "text-indigo-500 dark:text-indigo-400",
        addonButton: "hover:bg-indigo-100 text-indigo-400 hover:text-indigo-500 dark:hover:bg-indigo-900/50 dark:text-indigo-400 dark:hover:text-indigo-200",
    },
    purple: {
        root: "bg-purple-50 text-purple-700 ring-purple-200/80 dark:bg-purple-950/40 dark:text-purple-300 dark:ring-purple-800/60",
        addon: "text-purple-500 dark:text-purple-400",
        addonButton: "hover:bg-purple-100 text-purple-400 hover:text-purple-500 dark:hover:bg-purple-900/50 dark:text-purple-400 dark:hover:text-purple-200",
    },
    pink: {
        root: "bg-pink-50 text-pink-700 ring-pink-200/80 dark:bg-pink-950/40 dark:text-pink-300 dark:ring-pink-800/60",
        addon: "text-pink-500 dark:text-pink-400",
        addonButton: "hover:bg-pink-100 text-pink-400 hover:text-pink-500 dark:hover:bg-pink-900/50 dark:text-pink-400 dark:hover:text-pink-200",
    },
    orange: {
        root: "bg-orange-50 text-orange-700 ring-orange-200/80 dark:bg-orange-950/40 dark:text-orange-300 dark:ring-orange-800/60",
        addon: "text-orange-500 dark:text-orange-400",
        addonButton: "hover:bg-orange-100 text-orange-400 hover:text-orange-500 dark:hover:bg-orange-900/50 dark:text-orange-400 dark:hover:text-orange-200",
    },
};
...
interface BadgeProps<T extends BadgeTypes | "badge-color"> {
    type?: T;
    size?: Sizes;
    color?: BadgeColors;
    children: ReactNode;
...
export const Badge = <T extends BadgeTypes | "badge-color">(props: BadgeProps<T>) => {
    const { type = "pill-color", size = "md", color = "gray", children } = props;
    const colors = withPillTypes[type] || withPillTypes[badgeTypes.badgeColor] || withPillTypes[badgeTypes.pillColor];
    ...
    const sizeClass = (sizes as any)[type]?.[size] || badgeSizes[size] || badgeSizes.sm;
    const styleClass = (colors.styles as any)?.[color]?.root || colors.styles?.gray?.root || "";

    return <span className={cx(colors.common, sizeClass, styleClass, props.className)}>{children}</span>;
};
